...
public class ListEvaluation {
    private static void loadList(List<Integer> list, int numberOfElements){
    ...
    public static void removeElementsFromBeginning(List<Integer> list, int numberOfElementsToAdd) {
        for (int i = 0; i < numberOfElementsToAdd; i++) {
            list.remove(0);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        loadList(arrayList, 1_000_000);
        loadList(linkedList,1_000_000);
